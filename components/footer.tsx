  ...
  return (
    <footer className="mt-20 border-t border-border bg-card">
      ...
      <div className="site-shell grid gap-10 py-12 md:grid-cols-[1.5fr_1fr_1fr]">
        ...
        <div><p className="eyebrow mb-4 text-muted-foreground">Browse</p><div className="grid gap-3 text-sm"><Link href="/search">Request desk</Link><Link href="/discover">Lucky dip</Link><Link href="/discover/a-z">A–Z archive</Link></div></div>
